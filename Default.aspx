...
<asp:Content ID="OrderContent" ContentPlaceHolderID="OrderContent" runat="server">
   ...
   <li><button runat="server" id="order" class="btn btn-primary navbar-btn" onserverclick="order_ServerClick"><span class="glyphicon glyphicon-shopping-cart"></span> Order Now</button></li>
</asp:Content>
